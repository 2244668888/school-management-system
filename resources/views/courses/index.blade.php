        ...
        @forelse($courses as $course)
            <div class="col-md-4 mb-4">
                <div class="card">
                    ...
                    @else
                        <img src="{{ asset('storage/course_images/default.png') }}" class="card-img-top" alt="Default Image" style="height: 200px; width: 100%; object-fit: cover;">
                    @endif
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="{{ route('courses.edit', $course->id) }}" class="btn btn-info w-50 me-2">
